                    ...
                    <div class="modal-body">
                        <form action="Admin_ViewHalls.php" method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Hall Name" name="HallName" value="">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Rental Charge</label>
                                <input type="number" class="form-control" placeholder="Enter Rental Charge" name="RntlCharge" value="">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Hall Capacity</label>
                                <input type="number" class="form-control" placeholder="Enter Hall's Capacity" name="capacity" value="">
                            </div>
                            <div class="mb-3">
